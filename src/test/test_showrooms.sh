...
# shellcheck source=./helpers/showrooms_admin_suite.sh
# shellcheck disable=SC1091
source "$SCRIPT_DIR/helpers/showrooms_admin_suite.sh"
...
http_request "POST /showrooms/{id}/favorite (draft -> 404)" 404 "SHOWROOM_NOT_FOUND" \
  -X POST "${AUTH_HEADER[@]}" \
