export const ERROR_STATUS = {
    ...
    ACCESS_DENIED: 403,
    COUNTRY_BLOCKED: 403,
    USER_PROFILE_FIELDS_FORBIDDEN: 403,
...
export const ERROR_MESSAGE = {
    ...
    LOOKBOOKS_WRITE_MVP2_ONLY: "Lookbook RSVP endpoint is available in MVP2",
